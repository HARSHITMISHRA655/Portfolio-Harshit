...
>
  <a
    ...
    class="overflow-hidden bg-gradient-to-br from-purple-400 to-red-400 w-7 h-7 relative"
  >
    <p
      class="logo-type text-white dark:text-gray-900 text-3xl font-black flex "
    >
      H
    </p>
  </a>
  <a href="/#home" data-aos="flip-up" class="nav-text-home">Harshit</a>
  ...
  <div use:links class="hidden lg:flex gap-9 items-center ml-auto">
    <Router>
      ...
      <a
        href="/Harshit_Mishra_Resume_.pdf"
        data-aos="zoom-in"
        data-aos-delay="700"
        class="nav-text"
        data-aos-duration="700"
